...
export default class LogInForm {
  ...
  static getType() {
    ...
    const passwordValidationMessage = function (value, path, context) {
      const errorType = (value === null || value === undefined) ? 'is required' : 'can consist of A-Z, a-z, 0-9';
  ...
  static getForm() {
    return {
      service: {
        greeting: 'Welcome! Login and join the chat!',
        loginMsg: <p>If you are not registered, <i><a href="/sign-up">register now</a></i>.</p>,
        fields: [
          'email',
          'password'
        ]
